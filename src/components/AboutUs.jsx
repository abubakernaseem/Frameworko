          ...
          <div className="lg:pr-4">
            <div className="lg:max-w-lg">
              ...
              <p className="mt-6 text-xl/8 text-gray-700">
                Frameworko is a trusted IT solutions provider in Kuwait, Pakistan & GCC. We design websites, mobile apps & custom software with PayPal, Stripe & KNET payment support.
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="max-w-xl text-base/7 text-gray-600 lg:max-w-lg">
              ...
              <ul role="list" className="mt-8 space-y-8 text-gray-600">
                <li className="flex gap-x-3">
                  ...
                  <span>
                    <strong className="font-semibold text-gray-900">Requirement Gathering & Analysis</strong> In-depth discussions, workshops, and documentation to capture client needs and transform them into actionable technical plans.
                  </span>
                </li>
                <li className="flex gap-x-3">
                  <LockClosedIcon aria-hidden="true" className="mt-1 size-5 flex-none text-indigo-600" />
                  <span>
                    <strong className="font-semibold text-gray-900">Agile Development with Expert Teams</strong> Flexible and iterative development cycles using Agile/Scrum, ensuring faster delivery, adaptability and transparency.
                  </span>
                </li>
                <li className="flex gap-x-3">
                  <ServerIcon aria-hidden="true" className="mt-1 size-5 flex-none text-indigo-600" />
                  <span>
                    <strong className="font-semibold text-gray-900">Tools & Technologies for Excellence</strong> We use modern frameworks, cloud platforms, and collaboration tools (e.g., GitHub, Jira, Figma, CI/CD pipelines) to build robust, scalable and future-ready solutions.
                  </span>
                </li>
              </ul>
